...
const templates = {
  welcome: (name) => ({
    subject: 'Welcome to General Q&A!',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2>Welcome to General Q&amp;A!</h2>
        <p>Thank you for joining General Q&amp;A. We're excited to have you on board!</p>
        <p>You can now start asking questions, answering, and exploring community knowledge.</p>
        <p>Best regards,<br>The General Q&amp;A Team</p>
      </div>
    `
  }),
  ...
  orderConfirmation: (order) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Order Details:</p>
        ${orderDetails}
  <p>Thank you for choosing General Q&amp;A!</p>
  <p>Best regards,<br>The General Q&amp;A Team</p>
      </div>
    `
  }),
